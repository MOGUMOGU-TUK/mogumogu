...
export const styles = StyleSheet.create({
  ...
  profileEditAvatarImage: { width: "100%", height: "100%" },
  ...
  receivedReviewCard: { backgroundColor: "#fff", borderRadius: 16, padding: 16 },
  receivedReviewStars: { fontSize: 14, fontWeight: "800", color: t.rose },
  receivedReviewTitle: { fontSize: 15, fontWeight: "800", color: t.ink, marginTop: 8 },
  receivedReviewTag: { backgroundColor: t.calmBg, borderRadius: 9, paddingVertical: 5, paddingHorizontal: 9 },
  receivedReviewComment: { fontSize: 13, color: t.inkSoft, lineHeight: 19, marginTop: 11 },
